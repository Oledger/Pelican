...
import { ZapContainer, ZapMainHead, ZapOrangeHead, ZapTextContainer, ZapTextTag } from './styled'
...
const Vote = () => {
  ...
  return (
    <>
      ...
      <ZapContainer>
        <ZapTextContainer>
          <ZapMainHead>Zap</ZapMainHead>
          <ZapOrangeHead>1-Click convert tokens to LP tokens.</ZapOrangeHead>
          <ZapTextTag>WARNING: Zap can cause slippage. Small amounts only.</ZapTextTag>
        </ZapTextContainer>
        <BodyWrapper>
